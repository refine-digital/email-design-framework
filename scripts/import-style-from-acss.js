...
const STYLE_JSON_PATH = path.join(ROOT_DIR, 'src', 'design', 'acss', 'style.json');
const FRAMEWORK_JSON_PATH = path.join(ROOT_DIR, 'src', 'design', 'acss', 'framework.json');
const STYLE_CSS_PATH = path.join(ROOT_DIR, 'src', 'design', 'acss', 'automatic.css');
